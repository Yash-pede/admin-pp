import {
  ...
  export const ReqGSTBillChallan = ({ sales }: { sales?: boolean }) => {
    const go = useGo();
    ...
    return (
      <List canCreate={false} breadcrumb={false} title="Request To Create GST Bill">
        <Table
          {...tableProps}
          rowKey="id"
          bordered
                ...
                <Tooltip title="Delete">
                  <Button
                    ...
                    onClick={() =>
                      mutate({
                        id: record.id,
                        values: { gst_bill_status: "CREATED" },
                      })
                    }
                  >
                    <CheckOutlined />{" "}
                ...
                <Tooltip title="Cancel">
                  <Button
                    ...
                    onClick={() =>
                      mutate({
                        id: record.id,
                        values: { gst_bill_status: "CANCELLED" },
                      })
                    }
                  >
                    <CloseOutlined />{" "}
